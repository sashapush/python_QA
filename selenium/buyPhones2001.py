...
phones_list = driver.find_elements(By.CSS_SELECTOR, ".card.h-100") #alt css ".card-body" ".col-lg-3.col-md-6.mb-3" xpath //div[@class="card h-100"]
...
#4 checkout - checkout
driver.find_element(By.CSS_SELECTOR, ".nav-link.btn.btn-primary").click() #or use xpath //a[contains(text(),'Checkout')]
driver.find_element(By.XPATH, "//button[contains(text(),'Checkout')]").click() #or use xpath //a[contains(text(),'Checkout')]#
...
ass = driver.find_element(By.CSS_SELECTOR, ".alert.alert-success.alert-dismissible").text #one class can be used as well
print(ass)
